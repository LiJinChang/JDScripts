...
更新地址：https://jdsharedresourcescdn.azureedge.net/jdresource/jd_car.js
...
============小火箭=========
京东汽车 = type=cron,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_car.js, cronexpr="10 7 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东汽车');
